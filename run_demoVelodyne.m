...
base_dir  = '/home/dxq/data/datasets/kitti_odo/data_odometry_gray/sequences/00';
base_velo = '/home/dxq/data/datasets/kitti_odo/dataset_odo_velodyne/sequences/00/velodyne';
end
if nargin<2
  calib_dir = '/home/dxq/data/datasets/kitti_odo/data_odometry_gray/sequences/00/calib';
end
cam       = 0; % 0-based index
...
sprintf('%s/image_%01d/data/%010d.png',base_dir,cam,frame)
img = imread(sprintf('%s/image_%01d/%06d.png',base_dir,cam,frame));
fig = figure('Position',[20 100 size(img,2) size(img,1)]); axes('Position',[0 0 1 1]);
imshow(img); hold on;

% load velodyne points
fid = fopen(sprintf('%s/%06d.bin',base_velo,frame),'rb');
